...
namespace STSY.Identity.JWT.Generators.AccessTokens
{
    internal class JWTMFAccessTokenGenerator : IMFTokenGenerator
    {
        ...
        public async Task<TokenData> GenerateMFAToken(string resourceId, string resourceType)
        {
        ...
        public async Task<STSYTokenValidationResult> ValidateMFAToken(string token)
        {
