...
namespace STSY.Identity.Abstraction.Service
{
    public class StanderSessionCreator : ISessionManager
    {
        ...
        public async Task<Dictionary<string, object>> CreateSessionAsync(ExtendedUser user, string sessionId, CancellationToken cancellationToken = default)
        {
            ...
            tokenDatas["sessionId"] = sessionId;
        ...
        public async Task<Dictionary<string, object>> RefreshSessionAsync(ExtendedUser user, string sessionId, Dictionary<string, object> dataToValidate, CancellationToken cancellationToken = default)
        {
            if (!await ValidateSessionAsync(user, sessionId, dataToValidate, cancellationToken))
            {
        ...
        public async Task<bool> ValidateSessionAsync(ExtendedUser user, string sessionId, Dictionary<string, object> dataToValidate, CancellationToken cancellationToken = default)
        {
