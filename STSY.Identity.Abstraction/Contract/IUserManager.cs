...
namespace STSY.Identity.Abstraction.Contract
{
    public interface IUserManager
    {
        ...
        Task ChangeUserPassword(string newpassword, string oldpassword, CancellationToken cancellationToken);
        Task<string> GeneratePasswordResetTokenAsync(string userId, CancellationToken cancellationToken);
        Task ResetPassword(string userId, string resetToken, CancellationToken cancellationToken);
